...
pacman::p_load(downloader, caret, caretEnsemble, arm, C50, plyr, earth, mda, gbm, MASS, randomForest, sda, kernlab, xgboost)
set.seed(42)
```
...
if(!exists("pml_training") & !exists("pml_testing")){
        ...
        downloader(training_url, training_file)
        downloader(testing_url, testing_file)
        }
